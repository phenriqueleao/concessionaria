...
<body class="">
  <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="background-image: url('../img/Black-Dark-Spot-White-Texture-Background-Pattern-WallpapersByte-com-1366x768.jpg');">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="produtosDisponiveis.php">Produtos Disponiveis</a>
          </li>
          <li class="nav-item">
            <a class="btn btn-default navbar-btn btn-dark" href="produtosSelecionados.php">Produtos Selecionados</a>
          </li>
        </ul>
        <div class="col-md-3">
  ...
  <div class="py-5 h-75" style="background-image: url('../img/thumb-1920-719872.jpg');background-size:cover;background-position:right center;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-light">Produtos Selecionados</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <table class="table">
            ...
            <tbody>
              <?php
                ...
                $resultado=mostrarProdutosSelecionados($_SESSION['codigoUsuario']);
                   ...
                   while($linha=mysqli_fetch_assoc($resultado))
                   {
                      ...
                      echo "
                            <tr>
                              ...
                              href='../control/controlaVenda.php?opcao=tirarSelecao&codigo=$codigoEstoque'>Remover Seleção</a></td>
                            </tr>
                           ";
                ...
                if($total)
                {
                  echo"
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td class='text-light'><b>Preço total</b>: $total $</td>
                        </tr>
                      ";
                }
              }
